...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({pattern: 'start ?(.*)', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
        ...
        if (match[1] === '') {
            ...
            await message.client.sendMessage(
                message.jid,'●▬▬▬ 🔴*WELCOME TO HOMEDITORID*🔴 ▬▬▬●\n_Suport Bay HomeditorID_\nLink Group Wa : https://tinyurl.com/ygq8n5mo\n\n' + CMD_HELP, MessageType.text
            );    
        } else {
            var CMD_HELP = '';
            Asena.commands.map(
    ...
    Asena.addCommand({pattern: 'start ?(.*)', fromMe: false, dontAddCommandList: true}, (async (message, match) => {
